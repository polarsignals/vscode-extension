...
class InitiateUploadRequest$Type extends MessageType<InitiateUploadRequest> {
  ...
  internalBinaryWrite(
    ...
    if (message.buildId !== '') writer.tag(1, WireType.LengthDelimited).string(message.buildId);
    /* int64 size = 2; */
    if (message.size !== 0n) writer.tag(2, WireType.Varint).int64(message.size);
    /* string hash = 3; */
    if (message.hash !== '') writer.tag(3, WireType.LengthDelimited).string(message.hash);
    /* bool force = 4; */
    if (message.force !== false) writer.tag(4, WireType.Varint).bool(message.force);
...
export const DebuginfoService = new ServiceType('parca.debuginfo.v1alpha1.DebuginfoService', [
  {
    ...
    options: {'google.api.http': {post: '/upload', body: '*'}},
    I: UploadRequest,
    O: UploadResponse,
  },
  {
    name: 'ShouldInitiateUpload',
    options: {'google.api.http': {post: '/shouldinitiateupload', body: '*'}},
    I: ShouldInitiateUploadRequest,
    O: ShouldInitiateUploadResponse,
  },
  {
    name: 'InitiateUpload',
    options: {'google.api.http': {post: '/initiateupload', body: '*'}},
    I: InitiateUploadRequest,
    O: InitiateUploadResponse,
  },
  {
    name: 'MarkUploadFinished',
    options: {'google.api.http': {post: '/markuploadfinished', body: '*'}},
