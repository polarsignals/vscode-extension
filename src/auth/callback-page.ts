...
<body>
  <div class="header">
    <svg viewBox="0 0 1951.2 274.26" xmlns="http://www.w3.org/2000/svg" aria-label="Polar Signals">${LOGO_PATHS}</svg>
  </div>
